...
$(document).ready(function() {
  ...
  //Initialize the svg
  var heighthistSVG = d3
    .select("#heighthist-SVG")
    .append("svg")
    .attr("width", w)
    .attr("height", h)
  ...
  function unfillBars() {
    ...
    heighthistSVG.selectAll(".bar").attr("stroke", fgColor);
  }
  ...
  function fillBars() {
    ...
    heighthistSVG.selectAll(".bar").attr("stroke", bgColor);
  }
  ...
  function animate_bars() {
    heighthistSVG
      ...
      .transition()
      .duration(function() {
        return getRndInteger(1000, 3000);
      })
      .delay(function() {
        return getRndInteger(0, 2000);
      })
      .attr("height", function() {
        return getRndInteger(20, 120);
      })
      .style("fill", function(d) {
        return color(getRndInteger(0, 9));
      });
  }
